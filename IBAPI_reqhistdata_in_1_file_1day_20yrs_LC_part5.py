...
def getData(contracts, defaultid):
    for i in contracts:
        ...
        time.sleep(7.5)  # sleep to allow enough time for data to be returned
        try:
            ...
            #to_csv(..., sep=';')
            df.to_csv(r'C:\Users\user\PycharmProjects\pythonProject\LargeCap_List_20Y_1D_part5.csv', sep=';')
        except ValueError:
            pass
