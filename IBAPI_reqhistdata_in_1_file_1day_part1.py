...
scan = read_csv("Small_Mid_cap.csv", sep=';')
scan = scan[400:800]
...
app = IBapi()
app.connect('127.0.0.1', 7496, 200)
...
def getData(contracts, defaultid):
    for i in contracts:
        ...
        #to_csv(..., sep=';')
        df.to_csv(r'C:\Users\user\PycharmProjects\pythonProject\Small_Mid_List_10Y_1D_part2.csv', sep=';')
