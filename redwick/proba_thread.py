...
paramteric_study3 = pd.DataFrame(columns =[parameter_1, 'Trades', 'Win', 'Lose', 'w', 'e', 'Gain'])


start = time.time()
count = 0
def task1(paramteric_study, count):
    for ii in np.arange(1, 3, 0.5): # 14db
        R = ii
...
def task2(paramteric_study2, count):
    for ii in np.arange(3, 5, 0.5): # 14db
        R = ii
        ...
        paramteric_study2 = paramteric_study2.append(pd.DataFrame(result_list,
                                    columns =[parameter_1, 'Trades', 'Win', 'Lose', 'w', 'e', 'Gain']),
                       ignore_index=True)
        paramteric_study2.to_csv(f'C:\\Users\\user\\PycharmProjects\\pythonProject\\'
                                 f'parametric_study2.csv')
...
def task3(paramteric_study3, count):
    for ii in np.arange(5, 7, 0.5): # 14db
        R = ii
        ...
        print(result_list)
        #paramteric_study.append(result_list)
        paramteric_study3 = paramteric_study3.append(pd.DataFrame(result_list,
                                    columns =[parameter_1, 'Trades', 'Win', 'Lose', 'w', 'e', 'Gain']),
                       ignore_index=True)
        paramteric_study3.to_csv(f'C:\\Users\\user\\PycharmProjects\\pythonProject\\'
                                f'parametric_study3.csv')
...
t1 = Thread(target=task1, args=(paramteric_study, count))
t2 = Thread(target=task1, args=(paramteric_study2, count))
t3 = Thread(target=task1, args=(paramteric_study3, count))
