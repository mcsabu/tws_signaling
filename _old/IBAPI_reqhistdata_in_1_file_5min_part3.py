...
scan = read_csv("md_runnerek2021_2022.csv")
scan = scan[60:90]
...
def getData(contracts, defaultid):
    for i in contracts:
        ...
        time.sleep(150)  # sleep to allow enough time for data to be returned
        ...
        df.to_csv(f'C:\\Users\\user\\PycharmProjects\\pythonProject\\'
               f'Micro_List_2Y_5m_part3423767.csv', index=False, sep=';')
