...
def top_pc_gain_Scan(asset_type="STK", asset_loc="STK.US.MAJOR", scan_code="TOP_PERC_GAIN"):
    ...
    scanSub.numberOfRows = 7 # prem 10; RTH 20
    scanSub.abovePrice = 0.75
    scanSub.belowPrice = 20
    scanSub.aboveVolume = 100000 #prem 100k, RTH 200k
...
def Redwick_Strategy(df):
    ...
    param6 = 10
    param7 = 0.33
    param8 = 100000 #premarket 100k, RTH 200k
    param9 = 1
    param10 = 0.66
    param11 = 3000000
    param12 = 100000
    ...
    if df['buy_signal'].iat[-1] == True:
        ...
        '''
        winsound.PlaySound('C:\\Users\\user\\PycharmProjects\\pythonProject\\trading_bot\\'
